...
set JAVA=java
rem if exist "%JAVA_HOME%\bin\java.exe" goto setJavaHome
if exist "%JAVA_HOME%\Library\Java\JavaVirtualMachines\adoptopenjdk-8.jdk\bin\java.exe" goto setJavaHome
goto run

:setJavaHome
rem set JAVA="%JAVA_HOME%\bin\java.exe"
set JAVA="%JAVA_HOME%\Library\Java\JavaVirtualMachines\adoptopenjdk-8.jdk\bin\java.exe"
